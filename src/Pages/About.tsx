...
const About: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="bg-black text-white h-[50vh] flex items-end pb-15 justify-center">
        <h1 className="text-4xl sm:text-4xl md:text-6xl lg:text-7xl font-light tracking-[0.3em] text-center">
          WHO WE ARE
        </h1>
      </section>
      ...
      <section className=" mx-auto ">
        <div className="w-full h-96 md:h-[500px] lg:h-[600px] bg-gray-300 rounded-lg overflow-hidden">
          <img
            src={bg1}
        ...
        <div className="grid md:grid-cols-2 gap-12  items-center">
          ...
          <div>
            <p className="text-gray-700 leading-relaxed">
              ...
              beyond the House of Maitri sphere. Our extensive team and
              ...
              allowing us to push our innovative boundaries continuously.
            </p>
