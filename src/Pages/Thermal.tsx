...
const Thermal = () => {
  ...
  const [activePopup, setActivePopup] = useState<'POWERELECTRONICS' | 'PHOTONICS' | 'AEROSPACE' | null>(null);
...
<section className="px-5 py-2 mb-4 2xl:px-23 sm:py-4">
  ...
  <div className="grid grid-cols-1 lg:grid-cols-12 gap-0 border-2 border-[#CDAE64]">
    ...
    <section className="">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-0 border-b-2 border-t-2 border-[#C8AB6E]">
          ...
          <div className="grid grid-cols-1 lg:col-span-6 md:grid-cols-3">
            ...
            className="relative overflow-hidden group cursor-pointer border-b-2 md:border-b-0 md:border-l-2 md:border-r-2  border-[#C8AB6E]">
              <div className="p-1">
                <h3 className="text-black text-sm lg:text-lg font-semibold tracking-wide text-center mb-1 sm:mb-4 font-[Galderglynnlt]">
                Power Electronics
                </h3>
      ...
      <Rquestbutton />
  {activePopup === 'POWERELECTRONICS' && <POWERELECTRONICS onClose={() => setActivePopup(null)} />}
      {activePopup === 'PHOTONICS' && <PHOTONICS onClose={() => setActivePopup(null)} />}
      {activePopup === 'AEROSPACE' && <AEROSPACE onClose={() => setActivePopup(null)} />}
      <PopUp
