        ...
        <div className=" bg-white p-2 flex items-center justify-center ">
          <div className=" w-full lg:flex-1">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-2 sm:gap-12 md:gap-4 lg:gap-14 xl:gap-24">
              <div>
                <div className="border-2 border-[#c5a867] bg-white p-6 sm:p-8 md:p-10 lg:p-10 xl:p-12 h-[300px] sm:h-[350px] md:h-[450px] lg:h-[450px] xl:h-[550px] flex flex-col justify-center">
                 ...
                 <p className="text-gray-500 pt-3 text-xs sm:text-sm md:text-base lg:text-[18px] leading-relaxed tracking-wider text-center font-[Montserratmd] px-2 sm:px-4 md:px-8 lg:px-1 xl:px-18">
                  Breakdown voltage 10x higher than silicon and 4–5x higher than <br />
                  Gallium Nitride (GaN)
                </p>
              </div>
              ...
              <div>
                <div className="border-2 border-[#c5a867] bg-white sm:p-2 md:p-2 lg:p-10 xl:p-12 h-[300px] sm:h-[350px] md:h-[400px] lg:h-[450px] xl:h-[550px] relative">
                  ...
                  <div className="flex items-end  justify-around gap-1 md:gap-10 lg:gap-4 xl:gap-18 2xl:gap-24 h-[220px] sm:h-[260px] md:h-[300px] lg:h-[350px] xl:h-[450px] mt-19 sm:mt-19 md:mt-22 lg:mt-14 xl:mt-12 2xl:mt-12">
                    <div className="flex items-end gap-2 sm:gap-3 md:gap-4">
                      <div className="w-10 md:w-14 lg:w-14 xl:w-14 2xl:w-17 rounded-t-lg bg-black flex items-center justify-center" style={{ height: "240px" }}>
                      ...
                      <div className="w-10 md:w-14 lg:w-14 xl:w-14 2xl:w-17 rounded-t-lg border-t-2 border-r-2 border-l-2 border-[#c5a867] bg-white" style={{ height: "280px" }}></div>
                    </div>

                    <div className="flex items-end gap-2 sm:gap-3 md:gap-4">
                      <div className="w-10 md:w-14 lg:w-14 xl:w-14 2xl:w-17 rounded-t-lg bg-black flex items-center justify-center" style={{ height: "260px" }}>
                        <span className="text-white text-[10px] sm:text-xs md:text-base lg:text-lg font-bold transform -rotate-90 whitespace-nowrap font-[Montserratmd] tracking-wide">
                          {'>'}30W/MM
                        </span>
                      </div>
                      <div className="w-10 md:w-14 lg:w-14 xl:w-14 2xl:w-17 border-t-2 border-r-2 border-l-2 border-[#c5a867] bg-white rounded-t-lg" style={{ height: "160px" }}></div>
                    </div>

                    <div className="flex items-end gap-2 sm:gap-3 md:gap-4">
                      <div className="w-10 md:w-14 lg:w-14 xl:w-14 2xl:w-17 rounded-t-lg bg-black flex items-center justify-center" style={{ height: "210px" }}>
                        <span className="text-white text-[10px] sm:text-xs md:text-base lg:text-lg font-bold transform -rotate-90 whitespace-nowrap font-[Montserratmd] tracking-wide">
                          2–3X
                        </span>
                      </div>
                      <div className="w-10 xs:w-4 md:w-14 lg:w-14 xl:w-14 2xl:w-17 border-t-2 border-r-2 border-l-2 border-[#c5a867] bg-white rounded-t-lg" style={{ height: "130px" }}></div>
                    </div>
                  </div>
                </div>
                ...
                <p className="text-gray-600 font-[Montserratmd] text-center text-xs sm:text-sm md:text-sm lg:text-[14px] xl:text-lg leading-relaxed tracking-wider not-last:font-normal flex-1">
                  Power
                  <br />
                  Density
                </p>
