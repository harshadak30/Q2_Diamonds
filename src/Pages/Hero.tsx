...
//        <section className="min-h-screen bg-black flex items-center justify-center pt-40 px-4 pb-10">
//         <div className="flex flex-col items-center justify-center text-center max-w-6xl mx-auto">
//           <h1 className="text-white text-7xl md:text-6xl lg:text-7xl font-bold tracking-wider mb-8 md:mb-12">
//             QUANTUM QUEST
//           </h1>
//           <div className="relative">
//             {/* <svg viewBox="0 0 500 500" className="h-64 md:h-80 lg:h-96 w-auto max-w-full">
//               <circle cx="250" cy="250" r="140" fill="white"/>
//               <circle cx="250" cy="250" r="100" fill="black"/>
//               <line x1="310" y1="310" x2="380" y2="380" stroke="white" strokeWidth="30" strokeLinecap="round"/>
//               <text x="320" y="200" fill="white" fontSize="80" fontWeight="bold">2</text>
//                             <text x="250" y="460" fill="white" fontSize="40" fontWeight="300" letterSpacing="20" textAnchor="middle">DIAMONDS</text>
//             </svg> */}
...
//               src={Q2logo}
//               alt="Logo"
//               className="h-90 md:h-90 lg:h-140 w-auto max-w-full"
//             />
//           </div>
//           </div>
//         </div>
...
// <section className="min-h-screen bg-white px-4 md:px-8 lg:px-16 py-8 md:py-12">
//   <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6 lg:gap-8 max-w-8xl mx-auto">
...
const HeroSection: React.FC = () => {
  ...
  return (
    <div className="w-full overflow-x-hidden bg-black">
      {/* Hero Section */}
      <section className="min-h-screen bg-black flex items-center justify-center pt-30 px-4">
        <div className="flex flex-col items-center justify-center text-center max-w-6xl mx-auto">
          <h1 className="text-white text-5xl md:text-6xl lg:text-7xl font-bold mt-10">
            QUANTUM QUEST
          </h1>
...
<section className="min-h-screen bg-white px-4 md:px-8 lg:px-16 py-8 md:py-12">
   <p className="text-gray-400 text-sm md:text-5xl font-semibold text-center  mb-8">
           <span className="text-black"> POWERED BY </span> <span className="text-amber-600">HOUSE OF MAITRI </span>
          </p>
   <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6 lg:gap-8 max-w-8xl mx-auto">
     <Link to="/optics" className="block">
       <div className="relative h-64 sm:h-80 md:h-96 lg:h-[500px] overflow-hidden group rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300 cursor-pointer">
  ...
  <section
      ...
      <div className="bg-white py-12 overflow-hidden ">
        <div className="flex animate-marquee whitespace-nowrap">
          {[...items, ...items, ...items].map((item, i) => (
            <span key={i} className="text-5xl md:text-6xl font-bold mx-12 text-black">
              {item} <span className="text-3xl text-black-400">•</span>
            </span>
          ))}
        </div>
      </div>
