...
const OpticsLandingPage = () => {
  ...
  <div className="relative w-full">
    ...
    <div className="absolute inset-0 flex items-center justify-center">
      <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-galderglynn text-black font-semibold tracking-[0.2em] sm:tracking-[0.3em] md:tracking-[0.5em] lg:tracking-[0.75em]">
        OPTICS
      </h1>
    </div>
  </div>
...
">
      ...
      {/* Properties Section */}
     <section className="px-4 sm:px-6 md:px-8 lg:px-12 xl:px-20 py-8 md:py-8">
  <h2 className="text-4xl lg:text-5xl xl:text-6xl font-semibold tracking-wide text-center text-left mb-6 md:mb-0 ml-5">
    PROPERTIES
  </h2>
