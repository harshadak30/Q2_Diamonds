...
const BaseModal: React.FC<{
  ...
  return (
    ...
    >
      ...
      > */}
      <div
        className="bg-white w-full max-w-[78vw] sm:max-w-[50vw] md:max-w-3xl rounded-xl shadow-lg shadow-gray-500/50 my-6  md:my-16 mx-auto"
        onClick={(e) => e.stopPropagation()}
      >
        {children}
      </div>
          ...
          >
            ...
            {column.metrics.map((metric, metricIndex) => (
              <div
                ...
                style={{
                  margin: (metric as any).isStablePerformance
                    ? "10px 15px"
                    : "0",
                }}
              >
