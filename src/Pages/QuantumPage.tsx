...
//         <p
//           className="font-galderglynn text-[#767676] text-base sm:text-base md:text-xl lg:text-2xl leading-relaxed tracking-wide sm:tracking-widest text-center md:text-left text-justify
// "
//         >
...
//           <div className="bg-white  overflow-hidden">
//             <div className="grid grid-cols-2 h-[500px] md:h-[450px] sm:h-[300px]">
...
//  <section className="px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 py-8 md:py-12 mb-10">
//       <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-5xl xl:text-6xl font-semibold tracking-wide text-left mb-6 md:mb-8">
//         PROPERTIES
//       </h2>
...
//         <div className="bg-white border-1 border-[#C4A55A] overflow-hidden">
//           <div className="w-full h-full flex flex-col items-center justify-center p-8 sm:p-12 md:p-16">
//             <h3 className="text-6xl sm:text-7xl md:text-[160px] font-bold text-[#C4A55A] mb-6 md:mb-8">
//               100X
//             </h3>
//             <p className="text-base sm:text-lg md:text-xl font-semibold text-black text-center">
...
//         {/* Right Box - 2x2 Grid with Borders */}
//         <div className="bg-white  overflow-hidden">
//           <div className="grid grid-cols-2 min-h-[400px] sm:min-h-[450px] md:min-h-[400px] lg:min-h-[500px]">
//             {/* Top Left */}
//             <div className="flex items-start justify-start border-b-1 border-r-1 border-[#C4A55A] p-6 sm:p-8 md:p-10 lg:p-1">
//               <div className="text-left">
//                 <h3 className="text-2xl sm:text-3xl md:text-4xl lg:text-4xl xl:text-5xl font-semibold mb-1 sm:mb-2 text-[#C4A55A] leading-tight">
//                   Excellent
//                 </h3>
//                 <h3 className="text-2xl sm:text-3xl md:text-4xl lg:text-4xl xl:text-5xl font-semibold mb-2 sm:mb-3 text-[#C4A55A] leading-tight">
//                   Integration
//                 </h3>
//                 <p className="text-sm sm:text-base md:text-lg lg:text-lg xl:text-2xl font-semibold text-black">
//                   with Photonics System
//                 </p>
//               </div>
//             </div>
...
//             {/* Top Right */}
//             <div className="flex items-start justify-start border-b-1 border-[#C4A55A] p-6 sm:p-8 md:p-10 lg:p-1">
//               <div className="text-left">
//                 <p className="text-sm sm:text-base md:text-lg lg:text-lg xl:text-2xl font-semibold text-black mb-1 sm:mb-2">
//                   Operates At
//                 </p>
//                 <h3 className="text-2xl sm:text-3xl md:text-4xl lg:text-4xl xl:text-5xl font-semibold mb-1 text-[#C4A55A] leading-tight">
//                   Room
//                 </h3>
//                 <h3 className="text-2xl sm:text-3xl md:text-4xl lg:text-4xl xl:text-5xl font-semibold text-[#C4A55A] leading-tight">
//                   Temperature
//                 </h3>
//               </div>
//             </div>
...
//             {/* Bottom Left */}
//             <div className="flex items-start justify-start border-r-1 border-[#C4A55A] p-6 sm:p-8 md:p-10 lg:p-1">
//               <div className="text-left">
//                 <h3 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-5xl font-semibold mb-2 sm:mb-3 text-[#C4A55A]">
//                   2ms
//                 </h3>
//                 <p className="text-sm sm:text-base md:text-lg lg:text-lg xl:text-2xl font-semibold text-black">
//                   Spin Coherence
...
//             {/* Bottom Right */}
//             <div className="flex items-start justify-start p-6 sm:p-8 md:p-10 lg:p-6">
//               <div className="text-left">
//                 <p className="text-sm sm:text-base md:text-lg lg:text-lg xl:text-2xl font-semibold text-black mb-1 sm:mb-2">
//                   Unmatched
//                 </p>
